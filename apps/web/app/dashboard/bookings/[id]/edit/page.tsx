        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              Update the booking details below. Changes will update the reservation.
            </p>
          </CardHeader>
          <CardContent>
        ...
        <Card className="mt-6 border-yellow-200 bg-yellow-50">
          <CardContent className="pt-6">
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-yellow-900">Editing Active Booking</p>
                <p className="mt-1 text-sm text-yellow-800">
                  Changes to the date or time will check for conflicts with existing bookings.
                  The system will prevent overlapping reservations.
                </p>
              </div>
            </div>
          </CardContent>
