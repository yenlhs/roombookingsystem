...
export default function BookRoomScreen() {
  ...
  const handleDateSelect = async (date: string) => {
    ...
    try {
      const availabilityData = await bookingService.getRoomAvailability(roomId as string, date);
    ...
    <View className="flex-1 bg-slate-50">
      <ScrollView className="flex-1">
        <View className="p-6 pb-24">
          {/* Back Button */}
          <TouchableOpacity onPress={() => router.back()} className="mb-6">
            <Text className="text-blue-600 font-semibold text-base">← Back to Room</Text>
          </TouchableOpacity>

          {/* Header */}
          <View className="mb-6">
            <Text className="text-3xl font-bold text-gray-900 mb-2">Book a Room</Text>
          ...
          {step === 'confirm' && selectedSlot && (
            <View>
              ...
              <Text className="text-xl font-bold text-gray-900 mb-4">Confirm Your Booking</Text>
                ...
                <View className="space-y-3">
                  <View className="flex-row items-center">
                    ...
                    <View className="flex-1">
                      ...
                      <Text className="text-base font-semibold text-gray-900">{room?.name}</Text>
                    </View>
                  </View>
                  ...
                  {room?.capacity && (
                    <View className="flex-row items-center">
                      <Text className="text-2xl mr-3">👥</Text>
                      <View className="flex-1">
                        <Text className="text-xs text-gray-500 uppercase">Capacity</Text>
                        <Text className="text-base font-semibold text-gray-900">
