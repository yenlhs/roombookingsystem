...
serve(async (req) => {
  try {
    ...
    console.log('[9] Subscription query result:', { subscription, subscriptionError });
    ...
    console.log('[12] Creating Stripe portal session for customer:', subscription.stripe_customer_id);
